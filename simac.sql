...
CREATE TABLE `factura` (
  ...
  `forma_pago` enum('Deposito','Efectivo','Transferencia') NOT NULL,
  `folio_trabajo` int(11) NOT NULL,
  `rfc_solicitante` varchar(13) NOT NULL,
  PRIMARY KEY (`folio`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `factura` VALUES (232,2000,'2017-03-30','Deposito',200,'BCA001206674'),(233,800,'2017-03-31','Efectivo',208,'BCA001206674'),(234,5000,'2017-04-01','Deposito',214,'BCA001206674'),(235,2500,'2017-04-01','Transferencia',215,'CCO7409189M1'),(236,400,'2017-04-02','Deposito',216,'CCO7409189M1'),(237,1200,'2017-04-02','Transferencia',218,'CCO7409189M1'),(238,3000,'2017-04-03','Transferencia',219,'CEM880726UZA'),(239,1500,'2017-04-03','Efectivo',221,'CEM880726UZA'),(240,1800,'2017-04-04','Transferencia',222,'CEM880726UZA'),(241,200,'2017-04-04','Deposito',223,'CAT021004JA4'),(242,6200,'2017-04-04','Deposito',225,'CAT021004JA4'),(243,600,'2017-04-05','Deposito',226,'CAT021004JA4'),(244,3000,'2017-04-06','Deposito',227,'DUL100819SR1'),(245,400,'2017-04-06','Efectivo',228,'DUL100819SR1'),(246,600,'2017-04-06','Deposito',229,'DUL100819SR1'),(247,200,'2017-04-06','Transferencia',230,'FRO0303066G2'),(248,500,'2017-04-06','Deposito',231,'FRO0303066G2'),(249,150,'2017-04-06','Efectivo',232,'FRO0303066G2'),(250,1000,'2017-04-07','Efectivo',233,'LES860203JM8'),(251,1500,'2017-04-07','Efectivo',234,'LES860203JM8'),(252,550,'2017-04-07','Efectivo',236,'LES860203JM8');
...
-- Dump completed on 2017-04-20 23:44:41
